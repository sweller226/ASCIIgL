...
const std::vector<CatalogEntry>& GetBlockTextureCatalog() {
    static const std::vector<CatalogEntry> kCatalog = {
        ...
        {"minecraft:blocks/leaves_oak",        "res/textures/blocks/leaves_oak.png"},
        {"minecraft:blocks/planks_oak",        "res/textures/blocks/planks_oak.png"},
        {"minecraft:blocks/grass_top",         "res/textures/blocks/grass_top.png"},
        {"minecraft:blocks/grass_side",        "res/textures/blocks/grass_side.png"},
        {"minecraft:blocks/grass_side_overlay", "res/textures/blocks/grass_side_overlay.png"},
        ...
        {"minecraft:blocks/brick",             "res/textures/blocks/brick.png"},
        ...
        {"minecraft:blocks/fern",              "res/textures/blocks/fern.png"},
        {"minecraft:blocks/tallgrass",         "res/textures/blocks/tallgrass.png"},
    };
    return kCatalog;
}
