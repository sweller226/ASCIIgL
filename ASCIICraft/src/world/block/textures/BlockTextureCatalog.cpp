...
const std::vector<CatalogEntry>& GetBlockTextureCatalog() {
    static const std::vector<CatalogEntry> kCatalog = {
        ...
        {"minecraft:blocks/grass_side_overlay", "res/textures/Splotch/assets/minecraft/textures/blocks/grass_side_overlay.png"},
        // {"minecraft:blocks/grass_side_snowed",   "res/textures/Splotch/assets/minecraft/textures/blocks/grass_side_snowed.png"},  // modifed json for snow
        ...
        // {"minecraft:blocks/furnace_front_on",  "res/textures/Splotch/assets/minecraft/textures/blocks/furnace_front_on.png"}, // modified json for lit furnace
        ...
        {"minecraft:blocks/flower_rose",      "res/textures/Splotch/assets/minecraft/textures/blocks/flower_rose.png"},
    };
    return kCatalog;
}
