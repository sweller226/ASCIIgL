...
struct ChunkMeshData {
    ...
    std::vector<std::byte> opaqueNoCullVertices;
    std::vector<int> opaqueNoCullIndices;
    ...
    bool HasOpaqueNoCull() const {
        return !opaqueNoCullVertices.empty() && !opaqueNoCullIndices.empty();
    }
};
